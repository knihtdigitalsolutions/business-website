...
const Footer = ({
  ...
  logoSrc = "/kniht-final-logo-transparent.png",
}) => {
  ...
  return (
    <footer
      className={`rounded-t-xl shadow-lg ${theme.bg} py-12 px-4 mt-16 transition-colors duration-300`}
    >
      ...
      <div
        className={`mt-10 pt-6 border-t border-gray-700/50 ${theme.separatorBg} rounded-lg p-5`}
      >
        <SocialLinks
