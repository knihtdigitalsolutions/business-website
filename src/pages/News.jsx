  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 max-w-5xl mx-auto flex flex-col items-center text-center">
        <motion.h2
          className="text-4xl md:text-5xl font-extrabold text-fuchsia-700 dark:text-fuchsia-200 mb-6 drop-shadow-lg tracking-tight"
        ...
        <motion.p
          className="text-lg md:text-xl text-gray-700 dark:text-fuchsia-100 font-medium leading-relaxed mb-8"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          {[
            ...
            >
              ...
              <img
                src={item.img}
                alt={item.title}
                className="rounded-lg mb-4 w-full h-32 object-cover shadow-lg group-hover:shadow-fuchsia-400/30 transition-shadow"
              />
              <h4 className="text-lg font-bold mb-2 text-gray-900 dark:text-fuchsia-100 drop-shadow-lg tracking-wide group-hover:text-fuchsia-200 transition-colors">
                {item.title}
              </h4>
              <p className="text-sm text-center text-fuchsia-900 dark:text-fuchsia-100/90 group-hover:text-fuchsia-50 transition-colors">
                {item.desc}
              </p>
            </motion.div>
          ))}
